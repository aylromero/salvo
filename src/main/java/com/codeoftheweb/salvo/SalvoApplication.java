...
public class SalvoApplication {
    ...
    public CommandLineRunner initData(PlayerRepository playerRepository, GameRepository gameRepository, GamePlayerRepository gamePlayerRepository, ShipRepository shipRepository, SalvoRepository salvoRepository, ScoreRepository scoreRepository) {
        return (args) -> {
            Player player1= new Player("leo","Leonardo", "Vago","leo@gmail.com");
            Player player2= new Player("gri","Griselda", "Otalora", "griselda@gmail.com");
            Player player3= new Player("flor","Florencia", "Russo", "flor@gmail.com");
            Player player4= new Player("nico", "Nicolas", "Chiovetta", "nico@gmail.com");
            ...
            GamePlayer gp8 = new GamePlayer(player3, game4);
